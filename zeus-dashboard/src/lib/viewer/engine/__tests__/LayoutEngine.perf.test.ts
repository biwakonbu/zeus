...
describe('LayoutEngine パフォーマンステスト', () => {
	...
	describe('レイアウト結果の正確性', () => {
		...
		it('依存関係のあるノードは異なるレイヤーに配置される', () => {
			...
			const tasks = [
				{ id: 'task-0', title: 'Task 0', status: 'pending' as const, dependencies: [] },
				{ id: 'task-1', title: 'Task 1', status: 'pending' as const, dependencies: ['task-0'] },
				{ id: 'task-2', title: 'Task 2', status: 'pending' as const, dependencies: ['task-1'] }
			];
