...
Zeus プロジェクト（{{.ProjectName}}）の 10概念モデル全体（Vision, Objective, Deliverable, Consideration, Decision, Problem, Risk, Assumption, Constraint, Quality）および Actor/UseCase/Subsystem/Activity を分析します。
