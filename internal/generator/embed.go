...
//
//go:generate sh -c "mkdir -p assets/agents assets/skills/zeus-suggest assets/skills/zeus-risk-analysis assets/skills/zeus-wbs-design assets/skills/zeus-e2e-tester"
